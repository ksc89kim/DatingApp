...
let paths: [String] = [
    "Projects/Features/Chat/.swiftlint.yml",
    "Projects/Features/Main/.swiftlint.yml",
    "Projects/Features/Onboarding/.swiftlint.yml",
    "Projects/Features/User/.swiftlint.yml",
